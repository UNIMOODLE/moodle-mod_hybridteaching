...
class instances extends instances_controller {
    public static function load_instance($instanceid) {
        global $DB;
        $zoomdata = $DB->get_record('hybrid_zoom_instances', ['id' => $instanceid]);
        return $zoomdata;
    }
    public static function create_instance($data) {
        ...
        $id=$DB->insert_record('hybrid_zoom_instances', $zoomrecords);
        return $id;
    }
    ...
    public static function update_instance($data) {
        ...
        $DB->update_record('hybrid_zoom_instances', $zoomrecords);
    }

    public static function delete_instance($instanceid) {
        global $DB;
        $instanceid = ['id' => $instanceid];
        $DB->delete_records('hybrid_zoom_instances', $instanceid);
    }
}
