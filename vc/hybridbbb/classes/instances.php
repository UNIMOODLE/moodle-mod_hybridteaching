...
class instances {
    public static function load_instance($instanceid) {
        global $DB;
        $bbbdata = $DB->get_record('hybrid_bbb_instances', ['id' => $instanceid]);
        return $bbbdata;
    }
    public static function create_instance($data) {
        ...
        $id=$DB->insert_record('hybrid_bbb_instances', $records);
        return $id;
    }
    ...
    public static function update_instance($data) {
        ...
        $DB->update_record('hybrid_bbb_instances', $records);
    }

    public static function delete_instance($instanceid) {
        global $DB;
        $instanceid = ['id' => $instanceid];
        $DB->delete_records('hybrid_bbb_instances', $instanceid);
    }
}
