 ...
 */
  ...
  */
class hybridbbb_instance_edit_form extends moodleform {
    /**
    ...
    public function definition() {
        ...
        $mform->addElement('header', 'subplugin', get_string('pluginname', 'hybridteachingvc_hybridbbb'));
        $mform->addElement('text', 'serverurl', get_string('serverurl', 'hybridteachingvc_hybridbbb'));
        $mform->addElement('text', 'sharedsecret', get_string('sharedsecret', 'hybridteachingvc_hybridbbb'));
        $mform->addElement('text', 'pollinterval', get_string('pollinterval', 'hybridteachingvc_hybridbbb'));
