...
$client_id = "f2586839-35c4-4dca-bd1f-c2e5ccc528de";  //Application (client) ID
$ad_tenant = "1b2b6af1-b62d-452c-94b5-3349bede3179";  //Azure Active Directory Tenant ID, with Multitenant apps you can use "common" as Tenant ID, but using specific endpoint is recommended when possible
$client_secret = "vHS8Q~wJccKtG92-mIDUOwLb3JZ.CZIO2dby0a~P";  //Client Secret, remember that this expires someday unless you haven't set it not to do so
$redirect_uri = "https://marian.moodle41.com/mod/hybridteaching/vc/teams/classes/test1.php";  //This needs to match 100% what is set in Azure
$error_email = "adminisyc@nhb7.onmicrosoft.com";  //If your php.ini doesn't contain sendmail_from, use: ini_set("sendmail_from", "user@example.com");
