 ...
 *
 */
class restore_hybridteachvc_bbb_subplugin extends restore_subplugin {
    /**
    ...
    protected function define_session_subplugin_structure() {
        ...
        $elepath = $this->get_pathfor('/hybridteachvc_bbb');
    ...
    /**
     * Processes one hybridteachvc_bbb element
     * @param mixed $data
     */
    public function process_hybridteachvc_bbb_session($data) {
        global $DB;
        ...
        $newitemid = $DB->insert_record('hybridteachvc_bbb', $data);
        // We map the references of the restored record.
        $this->set_mapping('hybridteachvc_bbb', $oldid, $newitemid);
    }
}
