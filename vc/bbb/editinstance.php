...
$url = new moodle_url('/mod/hybridteaching/vc/bbb/editinstance.php');
$PAGE->set_url($url);
...
if (!empty($instanceid)) {
    ...
    $bbbinstance = instances::load_instance($instance->subplugininstanceid);
    unset($bbbinstance->id);
    $instance = (object) array_merge((array) $instance, (array) $bbbinstance);
}

$mform = new htbbb_instance_edit_form(null, array($instance, $type));
$message = '';
$error = '';
