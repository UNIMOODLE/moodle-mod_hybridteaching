 ...
 *
 */
class restore_hybridteachvc_zoom_subplugin extends restore_subplugin {
    /**
     ...
     * @param mixed $data
     */
    public function process_hybridteachvc_zoom_session($data) {
        global $DB;
        ...
        $newitemid = $DB->insert_record('hybridteachvc_zoom', $data);
        // We map the references of the restored record.
        $this->set_mapping('hybridteachvc_zoom', $oldid, $newitemid);
    }
}
