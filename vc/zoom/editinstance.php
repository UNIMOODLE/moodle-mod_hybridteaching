...
$url = new moodle_url('/mod/hybridteaching/vc/zoom/editinstance.php');
$PAGE->set_url($url);
...
if (!empty($instanceid)) {
    ...
    $zoominstance = instances::load_instance($instance->subplugininstanceid);
    unset($zoominstance->id);
    $instance = (object) array_merge((array) $instance, (array) $zoominstance);
}

$mform = new htzoom_instance_edit_form(null, array($instance, $type));
$message = '';
$error = '';
