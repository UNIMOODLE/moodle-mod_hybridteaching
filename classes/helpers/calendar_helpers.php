 ...
 */
function hybridteaching_create_calendar_events($sessionsids) {
    global $DB;
 ...
 */
function hybridteaching_update_calendar_event($session) {
    global $DB;
    ...
    if ($session->caleventid == 0) {
        return hybridteaching_create_calendar_event($session);
    }
 ...
 * @return bool result of updating
 */
function hybridteaching_delete_calendar_events($sessionid) {
    global $DB;
 ...
 */
function hybridteaching_existing_calendar_events_ids($sessionsids) {
    global $DB;
