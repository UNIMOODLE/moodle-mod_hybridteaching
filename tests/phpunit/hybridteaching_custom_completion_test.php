...
class hybridteaching_custom_completion_test extends \advanced_testcase {
     ...
     */
    public function test_custom_completion($param) {
        ...
        $data->description = $datadecoded->description;
        ...
        $completion = new custom_completion($cminfo, self::$user->id);
        // Get custom rules.
        $customrules = $completion->get_defined_custom_rules();
        // Get custom rule descriptions.
        $customdefinitions = $completion->get_custom_rule_descriptions();
        $this->assertNotNull($customdefinitions);
        // Get completion rules ordered.
        $customsortorder = $completion->get_sort_order();
