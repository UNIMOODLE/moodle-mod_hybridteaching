...
class hybridteaching_roles_test extends \advanced_testcase {
    ...
    public function test_roles($context = null, $role = null, $participantList = null) {
      ...
      /*  $reflectionMethod = new \ReflectionMethod(roles::class, 'get_roles_select');
        $reflectionMethod->setAccessible(true);
        $getrolesselect = $reflectionMethod->invoke($roles, self::$coursecontext, false);
        $ismoderator = roles::is_moderator(self::$coursecontext, $participantList);*/
