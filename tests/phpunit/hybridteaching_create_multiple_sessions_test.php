...
class hybridteaching_create_multiple_sessions_test extends \advanced_testcase {
     ...
     * @copyright  2023 Proyecto UNIMOODLE
     * @param string $param
     * @covers \hybridteaching_create_multiple_sessions::create_multiple_sessions
     * @dataProvider dataprovider
     * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
     */
    public function test_create_multiple_sessions($param, $period) {
        ...
        // Addmultiply allow us create multiple sesisons.
        $data->addmultiply = $datadecoded->addmultiply;
        $data->starttime = time();
